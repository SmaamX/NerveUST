...
def digN(logd):
  ...
  while True:
    ...
    if inps == "_":nuls2.inpux.append(me)
    if me >= random.randint(40,100):nuls.maj("_");p=nuls2.nerve_in("",True,"",45,50,False,False,True,False,True,True,50);nuls2.inpux.append(me)
